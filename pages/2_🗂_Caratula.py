...
nuestra_correlacion  =  st . barra lateral boton ( 'Nuestra Correlacion' )
...
st . barra lateral imagen ( 'https://upload.wikimedia.org/wikipedia/commons/3/3a/LOGO_UNSA.png' )
st . nieve ()
st . globos ()
si  inicio :
    st . nieve ()
    ...
    st . imagen ( 'https://s1.eestatic.com/2020/08/19/invertia/empresas/energia/transicion_energetica-inteligencia_artificial-energias_renovables_514209961_158012153_1706x960.jpg' )
